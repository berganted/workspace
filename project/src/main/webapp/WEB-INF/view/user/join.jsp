                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            	<th rowspan="3">주소</th>
                            	<td>
	                                <input type="text" name="zipcord" id="zipcode" value=""  style="float:left;"> 
	                                <a href="javascript:;" class="btn bgGray" onclick="zipcord();">우편번호</a>  
								</td>
						</tr>
						<tr>
							 	<td>
	                                 <input type="text" name="addr1" id="addr1" value=""  style="float:left ; width: 300px">
								</td>
						</tr>
						<tr>           
							 	<td>
	                                <input type="text" name="addr2" id="addr2" value=""  style="float:left;width: 300px">
								</td>                            
	                    </tr>
